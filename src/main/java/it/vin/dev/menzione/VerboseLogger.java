 ...
 * the VERBOSE custom log level.
 * <p>Compatible with Log4j 2.6 or higher.</p>
 */
public final class VerboseLogger extends ExtendedLoggerWrapper {
    private static final long serialVersionUID = 542475783873606L;
    private final ExtendedLoggerWrapper logger;

    private static final String FQCN = VerboseLogger.class.getName();
    private static final Level VERBOSE = Level.forName("VERBOSE", 450);

    private VerboseLogger(final Logger logger) {
     ...
     */
    public static VerboseLogger create() {
        final Logger wrapped = LogManager.getLogger();
        return new VerboseLogger(wrapped);
    }
     ...
     */
    public static VerboseLogger create(final Class<?> loggerName) {
     ...
     * @return The custom Logger.
     */
    public static VerboseLogger create(final Class<?> loggerName, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static VerboseLogger create(final Object value) {
     ...
     * @return The custom Logger.
     */
    public static VerboseLogger create(final Object value, final MessageFactory messageFactory) {
     ...
     * @return The custom Logger.
     */
    public static VerboseLogger create(final String name) {
     ...
     * @return The custom Logger.
     */
    public static VerboseLogger create(final String name, final MessageFactory messageFactory) {
